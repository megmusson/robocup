...
//      Serial.print(leftDistance);
  ...
  if (frontDistancer > FRONTLIMIT && frontDistancel > FRONTLIMIT && MlDistance > CORNERLIMIT && MrDistance > CORNERLIMIT) {
  ...
  else if (MrDistance < CORNERLIMIT && frontDistancer < FRONTLIMIT) {
  ...
  else if (MlDistance < CORNERLIMIT &&  frontDistancel < FRONTLIMIT ) {
