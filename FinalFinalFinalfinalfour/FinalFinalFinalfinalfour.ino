...
#include "IRfilter.h"
#include <SharpIR.h>
SharpIR right( SharpIR::GP2Y0A41SK0F, A0 );
SharpIR left( SharpIR::GP2Y0A41SK0F, A1 );
...
MedianFilter<int> medianMrFilter(3);
MedianFilter<int> medianMlFilter(3);
...
//      Serial.print(leftDistance);
  ...
  if (frontDistancer > FRONTLIMIT && frontDistancel > FRONTLIMIT && MlDistance > CORNERLIMIT && MrDistance > CORNERLIMIT && backflag == 0) {
    ...
    Serial.print("Nothing Ahead!");
  }
  ///////////////////////////////////////IF STATEMENT 2 - Front four detected//////////////////////////////////////////////////
  else if (frontDistancer < FRONTLIMIT && frontDistancel < FRONTLIMIT && MlDistance < CORNERLIMIT && MrDistance < CORNERLIMIT && backflag == 0) {

    frontDistancer = frontr.getDistance();
    frontDistancel = frontl.getDistance();
    MlDistance = Ml.getDistance();
    MrDistance = Mr.getDistance();
  ...
  else if ((MlDistance < CORNERLIMIT) && (MrDistance < CORNERLIMIT) && backflag == 0) {

    frontDistancer = frontr.getDistance();
    frontDistancel = frontl.getDistance();
    MlDistance = Ml.getDistance();
    MrDistance = Mr.getDistance();
    //    if ((frontDistancer > FRONTLIMIT) && (frontDistancel > FRONTLIMIT)) {
    //      go_forward(moveSpeed);
    //      Serial.print(" Corridor:");
    //
    //    }
    Serial.print("In a corner");
    turn_left(moveSpeed);
    delay(200);
  ...
  ///////////////////////////////////////IF STATEMENT 5//////////////////////////////////////////////////
  ...
  else if (MrDistance < CORNERLIMIT && backflag == 0) {
    ...
    MrDistance = Mr.getDistance();
    turn_left(moveSpeed);
    Serial.print("Close to right outside");
  ...
  ///////////////////////////////////////IF STATEMENT 7//////////////////////////////////////////////////
  ...
  else if (MlDistance < CORNERLIMIT && backflag == 0) {
    ...
    MrDistance = Mr.getDistance();
    turn_right(moveSpeed);
    Serial.print("Close to left outside");


  }
  ///////////////////////////////////////IF STATEMENT 8//////////////////////////////////////////////////

  else if (MrDistance < CORNERLIMIT && frontDistancer < FRONTLIMIT && backflag == 0) {
    ...
    MrDistance = Mr.getDistance();
    turn_left(moveSpeed);
    Serial.print("right side is blocked off");


  }
  ///////////////////////////////////////IF STATEMENT 9//////////////////////////////////////////////////

  else if (MlDistance < CORNERLIMIT &&  frontDistancel < FRONTLIMIT && backflag == 0) {
    ...
    MrDistance = Mr.getDistance();
    turn_right(moveSpeed);
    Serial.print("Left side is blocked off");
  ...
  ///////////////////////////////////////IF STATEMENT 10 - if front two blocked, use random number generator to move a random direction//////////////////////////////////////////////////
    ...
    MlDistance = Ml.getDistance();
    MrDistance = Mr.getDistance();
    Serial.print("Front two blocked, random move");

    int randNumber = random(0, 10);
    bool inloop = 1;
    if (randNumber % 2 == 0) {
      while ((inloop == 1) && (frontDistancer < FRONTLIMIT) && (frontDistancel < FRONTLIMIT) && (backflag == 0)) {
        frontDistancer = frontr.getDistance();
        frontDistancel = frontl.getDistance();
        turn_right(moveSpeed);
      }
